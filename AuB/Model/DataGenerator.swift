...
class DataGenerator {
    ...
    private static func MatBiec() -> BookSummaryModel {
        let bk = BookSummaryModel(name: "Mắt Biếc", author: "Nguyễn Nhật Ánh", chapters: "7", thumbnail: "mat-biec", shortDesc: "\"Tôi gửi tình yêu cho mùa hè, nhưng mùa hè không giữ nổi. Mùa hè chỉ biết ra hoa, phượng đỏ sân trường và tiếng ve nỉ non trong lá. Mùa hè ngây ngô, giống như tôi vậy. Nó chẳng làm được những điều tôi ký thác. Nó để Hà Lan đốt tôi, đốt rụi. Trái tim tôi cháy thành tro, rơi vãi trên đường về.\"")
    ...
    private static func ChuBeRacRoi() -> BookSummaryModel {
        let bk = BookSummaryModel(name: "Chú Bé Rắc Rối", author: "Nguyễn Nhật Ánh", chapters: "6", thumbnail: "chu-be-rac-roi", shortDesc: "Không biết các bạn như thế nào, chứ tôi thì tôi chưa từng lo cho ai bao giờ. Tôi lo cho chính tôi còn chưa xong nữa là. (mới mở đầu truyện thì nhân vật chính đã tâm sự như vậy rồi, nghe thấy \"Rắc Rối\"). Thực sự thì làm sao, vẫn là giọng văn “đọc tức cười”, cách thắt nút, mở nút đầy bất ngờ của tác giả dẫn ta đi hết rắc rối này đến rắc rối khác. Đọc rắc rối nhưng mà thấy thú vị.")
